module.exports = function(grunt){
    ...
    grunt.initConfig({
            ...
            production:{
                files: [
                    ...
                    },
                    {
                        expand: true,
                        flatten: true,
                        src: ['./source/jsons/*.json'],
                        dest: 'dist/jsons'
                    }
                ]
            }
        }
        // pngmin: { Aumenta o tamanho das imagens em vez de reduzir
        //     options: {
        //         ext: '.png', // Extensão do arquivo otimizado
        //         force: true, // Sobrescreve os arquivos no destino
        //         iebug: true,  // Corrige problemas de transparência no IE
        //         quality: "65-80",
        //         speed: 10
        //     },
        //     dist: {
        //         files: [{
        //             expand: true,
        //             cwd: "./source/images",   // Diretório base
        //             src: ["**/*.png"],        // Seleciona todos os arquivos .png
        //             dest: "./dist/images"     // Diretório de saída
        //         }]
        //     }
        // }
    })
    ...
    grunt.registerTask('build', ['less:production', 'htmlmin:production', 'replace:production', 'uglify', 'copy:production'])
